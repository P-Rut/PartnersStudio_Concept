...
const BasicInputs: React.FC<BasicInputProps> = ({
  ...
  return (
    <div className="mb-5">
      <input
        className="py-2 pl-7 w-full  text-gray-900 text-xl ring-inset border-black placeholder:text-black placeholder: font-thin focus:ring-2 focus:ring-inset focus:ring-indigo-600"
        type={type}
