    ...
    <>
      ...
      >
        <div className="flex-1 flex justify-center mr-auto py-3 px-10">
          ...
          >
            <Bars4Icon className="h-10 w-10 transition-all hover:scale-125  hover:text-indigo-800" />
          </button>
          ...
          >
            <div className=" text-indigo-900 h-screen bg-gray-50 absolute z-40 w-2/6 py-3 px-10 top-0 left-0">
              <XMarkIcon
                onClick={() => setIsOpen((prev) => !prev)}
                className="h-12 w-12 mb-10 cursor-pointer hover:scale-125 transition-all"
              />
          ...
          <span
            onClick={(e) => (window.location.href = "/offer")}
            className="flex flex-1 cursor-pointer transition-all transform hover:text-indigo-800 justify-end ml-auto  decoration-indigo-800 hover:text-2xl underline-offset-8 underline  text-xl font-light whitespace-nowrap"
          >
            How it works ?
          </span>
        </div>
