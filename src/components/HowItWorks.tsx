    ...
    <>
      ...
      <div className="m-10">
        ...
        <div className="grid grid-cols-3">
          <div className="p-10">
            <h1 className="text-center text-3xl mb-12">1. Design</h1>
          ...
          <div className="border-x border-indigo-800 p-10">
            <h1 className="text-center text-3xl mb-12">2. Document</h1>
            <p className="text-xl font-light text-center">
          ...
          <div className="p-10">
            <h1 className="text-center text-3xl mb-12">3. Build</h1>
            <p className="text-xl font-light text-center">
